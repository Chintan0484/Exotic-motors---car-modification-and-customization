      ...
      <!-- Signup section start -->
        <div class="contact_section layout_padding">
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <h1 class="contact_taital">Welcome Back!</h1>
                    </div>
                </div>
            </div>
            <div class="container">
                            ...
                            <div class="mail_section_1">
                                ...
                                <form method="POST" action="">
                                    <div class="form-group">
                                        <input type="email" id="email" name="email" class="mail_text" placeholder="Email" required><br>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" id="password" name="password" class="mail_text" placeholder="Password" required><br>
                                    </div>
                                    <div class="form-group">
                                        <div class="send_bt">
                                            <input type="submit" value="Login" style="width: 100%; text-align: center;font-size: 16px;color: #fefefd;background-color: #fe2929;padding: 12px;margin-top: 20px;display: block;border-radius: 5px; text-transform: uppercase; font-weight: bold;">
                                        </div>
                                    </div>
                                </form>
                            </div>
                            <div class="send_bt"><a href="signup.php">SignUp</a></div>
                        </div>
                    </div>
                </div>
            </div>
