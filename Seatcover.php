...
<html>
   ...
   <body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="gallery_taital">Seatcover</h1>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/1.png"></div>
                        <h3 class="types_text">Leather Seatcover</h3>
                        <p class="looking_text">High-quality leather seat cover for a premium look.</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/2.png"></div>
                        <h3 class="types_text">Fabric Seatcover</h3>
                        <p class="looking_text">Durable and comfortable fabric seat cover.</p>
                        <p class="looking_text">Price: ₹4500</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/3.png"></div>
                        <h3 class="types_text">Custom Seatcover</h3>
                        <p class="looking_text">Custom-fit seat cover for a perfect match.</p>
                        <p class="looking_text">Price: ₹4500</p>
        ...
        <div class="gallery_section_2">
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/4.png"></div>
                        <h3 class="types_text">Sporty Seatcover</h3>
                        <p class="looking_text">Sporty design seat cover for a stylish look.</p>
                        <p class="looking_text">Price: ₹4500</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/5.png"></div>
                        <h3 class="types_text">Luxury Seatcover</h3>
                        <p class="looking_text">Luxurious seat cover for enhanced comfort.</p>
                        <p class="looking_text">Price: ₹4500</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/6.png"></div>
                        <h3 class="types_text">Waterproof Seatcover</h3>
                        <p class="looking_text">Waterproof seat cover to protect against spills.</p>
                        <p class="looking_text">Price: ₹4500</p>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        ...
                        <h3 class="types_text">Eco-friendly Seatcover</h3>
                        <p class="looking_text">Eco-friendly seat cover made from recycled materials.</p>
                        <p class="looking_text">Price: ₹4500</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/8.png"></div>
                        <h3 class="types_text">Heated Seatcover</h3>
                        <p class="looking_text">Heated seat cover for added warmth in winter.</p>
                        <p class="looking_text">Price: ₹4500</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Seatcover/9.png"></div>
                        <h3 class="types_text">Cooling Seatcover</h3>
                        <p class="looking_text">Cooling seat cover for comfort in summer.</p>
                        <p class="looking_text">Price: ₹4500</p>
