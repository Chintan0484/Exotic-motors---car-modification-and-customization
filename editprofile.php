                            ...
                            <div class="container">
                                <form method="POST" action="">
                                    <div class="form-group">
                                        <input type="text" id="username" name="username" class="mail_text" placeholder="Username" value="<?php echo $user['username']; ?>" required><br>                                        
                                    </div>
                                    <div class="form-group">
                                        <input type="email" id="email" name="email" class="mail_text" placeholder="Email" value="<?php echo $user['email']; ?>" required><br>
                                    </div>
                                    <div class="form-group">
                                        <div class="send_bt">
                                            <input type="submit" value="Save Changes" style="width: 100%; text-align: center;font-size: 16px;color: #fefefd;background-color: #fe2929;padding: 12px;margin-top: 20px;display: block;border-radius: 5px; text-transform: uppercase; font-weight: bold;">
                                        </div>
                                    </div>
                                </form>
                            </div>
