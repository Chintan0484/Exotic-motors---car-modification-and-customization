...
<html>
   ...
   <body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="gallery_taital">Charging Parts</h1>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        ...
                        <h3 class="types_text">SuperFast Charger</h3>
                        <p class="looking_text">Price: ₹500</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/2.png"></div>
                        <h3 class="types_text">EcoCharge Plus</h3>
                        <p class="looking_text">Price: ₹450</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/3.png"></div>
                        <h3 class="types_text">UltraPower Charger</h3>
                        <p class="looking_text">Price: ₹520</p>
        ...
        <div class="gallery_section_2">
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/4.png"></div>
                        <h3 class="types_text">PowerBoost Charger</h3>
                        <p class="looking_text">Price: ₹480</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/5.png"></div>
                        <h3 class="types_text">SwiftCharge Charger</h3>
                        <p class="looking_text">Price: ₹490</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/6.png"></div>
                        <h3 class="types_text">TurboCharge Charger</h3>
                        <p class="looking_text">Price: ₹510</p>
        ...
        <div class="gallery_section_2">
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/7.png"></div>
                        <h3 class="types_text">RapidCharge Charger</h3>
                        <p class="looking_text">Price: ₹530</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/8.png"></div>
                        <h3 class="types_text">SpeedCharge Charger</h3>
                        <p class="looking_text">Price: ₹470</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/chargings/9.png"></div>
                        <h3 class="types_text">PowerDrive Charger</h3>
                        <p class="looking_text">Price: ₹540</p>
