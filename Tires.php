...
<body>
   ...
   <div class="container">
      <div class="row">
         <div class="col-md-12">
            <h1 class="gallery_taital">Tyres</h1>
         </div>
      </div>
         ...
         <div class="row">
            <div class="col-md-4">
               <div class="gallery_box">
                  ...
                  <h3 class="types_text">All-Terrain Pro</h3>
            ...
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/2.png"></div>
                  <h3 class="types_text">RoadMaster Elite</h3>
                  <p class="looking_text">price : $400</p>
            ...
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/3.png"></div>
                  <h3 class="types_text">Urban Cruiser</h3>
                  <p class="looking_text">price : $380</p>
      ...
      <div class="gallery_section_2">
         <div class="row">
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/4.png"></div>
                  <h3 class="types_text">TrailBlazer</h3>
                  <p class="looking_text">price : $360</p>
            ...
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/5.png"></div>
                  <h3 class="types_text">SpeedRacer</h3>
                  <p class="looking_text">price : $420</p>
            ...
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/6.png"></div>
                  <h3 class="types_text">Mountain Climber</h3>
                  <p class="looking_text">price : $370</p>
      ...
      <div class="gallery_section_2">
         <div class="row">
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/7.png"></div>
                  <h3 class="types_text">City Explorer</h3>
                  <p class="looking_text">price : $390</p>
            ...
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/8.png"></div>
                  <h3 class="types_text">Desert Runner</h3>
                  <p class="looking_text">price : $410</p>
            ...
            <div class="col-md-4">
               <div class="gallery_box">
                  <div class="gallery_img"><img src="images/Tires/9.png"></div>
                  <h3 class="types_text">Winter Warrior</h3>
                  <p class="looking_text">price : $430</p>
