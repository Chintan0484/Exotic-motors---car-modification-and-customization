...
<html>
   ...
   <body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="gallery_taital">Interior</h1>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/1.png"></div>
                        <h3 class="types_text">Leather Seats</h3>
                        <p class="looking_text">Price: ₹3200</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/2.png"></div>
                        <h3 class="types_text">Dashboard Cover</h3>
                        <p class="looking_text">Price: ₹1500</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/3.png"></div>
                        <h3 class="types_text">Floor Mats</h3>
                        <p class="looking_text">Price: ₹800</p>
        ...
        <div class="gallery_section_2">
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/4.png"></div>
                        <h3 class="types_text">Steering Wheel Cover</h3>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/5.png"></div>
                        <h3 class="types_text">Seat Covers</h3>
                        <p class="looking_text">Price: ₹1200</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/6.png"></div>
                        <h3 class="types_text">Gear Knob</h3>
                        <p class="looking_text">Price: ₹350</p>
        ...
        <div class="gallery_section_2">
            <div class="row">
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/7.png"></div>
                        <h3 class="types_text">Sun Visor</h3>
                        <p class="looking_text">Price: ₹200</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/8.png"></div>
                        <h3 class="types_text">Arm Rest</h3>
                        <p class="looking_text">Price: ₹900</p>
                ...
                <div class="col-md-4">
                    <div class="gallery_box">
                        <div class="gallery_img"><img src="images/Interior/9.png"></div>
                        <h3 class="types_text">Head Rest</h3>
                        <p class="looking_text">Price: ₹700</p>
