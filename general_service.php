...
<div class="contact_section layout_padding">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <h1 class="contact_taital">Car Service Booking</h1>
            </div>
        </div>
    </div>
    <div class="container">
                ...
                <div class="col-md-12">
                    <div class="mail_section_1">
                        <form action="book_service.php" method="POST">
                            ...
                            <input type="text" class="mail_text" placeholder="Year" name="car_year" required>
                            <input type="text" class="mail_text" placeholder="Service Type" name="service_type" required>
                            <input type="text" class="mail_text" placeholder="Preferred Date" name="preferred_date" required>
                            <textarea class="massage-bt" placeholder="Additional Details" rows="5" id="comment" name="additional_details" required></textarea>
                            <div class="send_bt"><input type="submit" value="Book Now"></div>
                        </form>
                    </div>
                </div>
            </div>
